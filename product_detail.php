                        ...
                        <div class="ambalaj">
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
                                <g id="Group_3821" data-name="Group 3821" transform="translate(0)">
                                    <g id="Rectangle_523" data-name="Rectangle 523" transform="translate(0 0)" fill="none" stroke="#fff" stroke-width="2">
                                        <rect width="36" height="36" rx="2" stroke="none"></rect>
                                        <rect x="1" y="1" width="34" height="34" rx="1" fill="none"></rect>
                                    </g>
                                    <path id="Path_235" data-name="Path 235" d="M23.963,13.227a.875.875,0,0,0-1.238.087l-2.5,3.25a.875.875,0,0,0,.087,1.238.888.888,0,0,0,1.238-.087l2.5-3.25A.875.875,0,0,0,23.963,13.227Z" transform="translate(-12.773 -9.8)" fill="#fff"></path>
                                    <path id="Path_236" data-name="Path 236" d="M19.522,19.522a.875.875,0,0,0-1.238.087l-1.25,1.625a.875.875,0,0,0,.087,1.238.888.888,0,0,0,1.238-.087l1.25-1.625A.875.875,0,0,0,19.522,19.522Z" transform="translate(-9.85 -12.225)" fill="#fff"></path>
                                </g>
