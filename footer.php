        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-4">
                    ...
                    <div class="footer-items">
                        ...
                        <p class="mb-2">Firmamız, endüstriyel boyada kalite ve dayanıklılık sunarak, her ihtiyaca özel
                            çözümler geliştirmektedir. Müşteri memnuniyetini ve yenilikçiliği ön planda tutan ekibimizle
                            sektörde güvenilir bir marka olmayı hedefliyoruz.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <!-- Footer Items -->
            ...
            <div
                ...
                <div class="copyright-right">Made with <i class="fas fa-heart"></i> By <a
                        href="https://github.com/devmustafaulutas">Adeus</a></div>
            </div>
        </div>
    </div>
</footer>
