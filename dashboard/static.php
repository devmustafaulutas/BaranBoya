                ...
                <?php if (mysqli_num_rows($items) > 0): ?>
                  <?php while ($r = mysqli_fetch_assoc($items)): ?>
                    <tr>
                      ...
                      <td><?= $r['updated_at'] ?></td>
                      <td>
                        <a href="static.php?action=edit&id=<?= $r['id'] ?>" class="btn btn-sm btn-warning">Düzenle</a>
                        <a href="static.php?action=delete&id=<?= $r['id'] ?>" class="btn btn-sm btn-danger"
            ...
            <form method="post">
              <div class="row g-3">
                ...
                <div class="col-lg-12">
                  ...
                  <textarea name="stext" class="form-control" rows="5"
                    required><?= $isEdit ? htmlspecialchars($edit['stext'], ENT_QUOTES) : '' ?></textarea>
                </div>
