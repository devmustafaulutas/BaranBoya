            ...
            <div class="card">
              <div class="card-body">
                <form method="post">
                  ...
                  <div class="mb-3">
                    <label class="form-label">Servis Başlık</label>
                    <input type="text" name="service_title" class="form-control" placeholder="Enter Service Title"
                      required>
                  </div>

                  <div class="mb-3">
                    <label class="form-label">Kısa Açıklama</label>
                    <textarea name="service_desc" class="form-control" rows="2" placeholder="Enter Short Description"
                      required></textarea>
                  </div>
                  <div class="mb-3">
