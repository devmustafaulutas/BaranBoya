            ...
            <div class="card-body">
              <form method="post" enctype="multipart/form-data">
                <div class="mb-3">
                  ...
                  <img src="../assets/img/tedarikcilerimiz/<?= htmlspecialchars($currentImage) ?>" alt="Tedarikçi" style="width:100px;">
                </div>
                <div class="mb-3">
